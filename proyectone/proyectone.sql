...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-04-2023 a las 21:35:36
...
INSERT INTO `registro` (`Id_registro`, `Nombre`, `Apellidos`, `Direccion`, `Telefono`, `FechaR`, `Email`) VALUES
(1, 'Carlos Alberto', 'Elias Villaseca', 'Avalos 55 San José de los Leones', '5520428642', '2005-01-02', 'carlosalberlias@gmail.com'),
(2, 'Brayan Moises', 'Martinez Teran', 'Tecolutla 92', '5520423456', '2005-05-22', 'moyses@gmail.com'),
(3, 'Leonel', 'Hernandez Garfias', 'Chile 87 juatepec', '5522587642', '2003-10-13', 'lionelG@gmail.com'),
(4, 'Andrea', 'Perez Alanis', 'Los cuartos Valle', '5520382736', '2004-11-23', 'perezalanis@gmail.com');
...
(10, 'Emilio', 'Ramirez', 'Hernandez', 1, 'eramirez1420@coonalepmex.edu.mx', '2', 1, '140503'),
(11, 'Diego', 'Alvarez', 'Gonzalez', 1, 'dangonzalez1020@conalepmex.edu.mx', '1', 2, 'DGG1'),
...
(19, 'Oscar', 'Garcia', 'Pozos', 1, 'jesusgarciapozos@gmail.com', '1', 1, '0342562'),
(20, 'Irving', 'Ramirez', 'Perez', 1, 'alejandrorp484@gmail,com', '1', 2, '122367Com22'),
(21, 'Caleb', 'Pedraza', 'Dorantes', 1, 'pedrazaalejandro224@gmail,com', '2', 1, '47A3412'),
...
(25, 'Michelle', 'Gomez', 'Hernandez', 2, 'gomezhernandezmichelle4@gmail.com', '1', 2, 'MICHELLE232323'),
(26, 'Joseline', 'Cruz', 'Segundo', 2, 'cruzjoselin40@gmail.com', '2', 2, 'N04A1V8l'),
...
ALTER TABLE `comentarios`
  ...
  ADD KEY `Id_Lugar` (`Id_Lugar`,`Id_Usuario`),
  ADD KEY `Id_Usuario` (`Id_Usuario`);
...
ALTER TABLE `galerialugar`
  ...
  ADD KEY `Id_Lugar` (`Id_Lugar`,`Id_Tusuario`),
...
ALTER TABLE `horario`
  ...
  ADD KEY `Id_Estatus` (`Id_Estatus`,`Id_Lugar`),
  ADD KEY `Id_Lugar` (`Id_Lugar`);
...
ALTER TABLE `lugares`
  ...
  ADD KEY `Id_Categoria` (`Id_Categoria`,`Id_Estado`,`Id_Municipio`,`Id_Horario`);
...
--
ALTER TABLE `userfacebook`
  MODIFY `Id_UserF` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `calificacionlugar`
  ...
  ADD CONSTRAINT `calificacionlugar_ibfk_2` FOREIGN KEY (`Id_Usuario`) REFERENCES `usuarios` (`Id_Usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `galerialugar`
  ADD CONSTRAINT `galerialugar_ibfk_1` FOREIGN KEY (`Id_Tusuario`) REFERENCES `tusuario` (`Id_Tusuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `galerialugar_ibfk_2` FOREIGN KEY (`Id_Lugar`) REFERENCES `lugares` (`Id_Lugar`) ON DELETE CASCADE ON UPDATE CASCADE;
